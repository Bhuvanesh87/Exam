...
namespace Server
{
    class ClientHandler
    {
        ...
        public void Run()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    foreach (KeyValuePair<string, ClientHandler> val in dSockets)  //for conncectiong client to client but for server automatically connected
                    {
        ...
        public void Send()  //server to all client
        {
            if (s != null)
            {
                while (true)
